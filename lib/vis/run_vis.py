...
def run_vis_on_demo(cfg, video, results, output_pth, smpl, vis_global=True):
    ...
    if vis_global:
        ...
        # need to study the `smpl.get_output` method, learn how does it utilize the pose and shape information to the vertices
        # `results[sid]["pose_world"]`, the first 3 element represents the global orientation,
        # the rest 21 elements represent the body pose
        # `results[sid]["betas"]` represents the shape of the body
        # `results[sid]["trans_world"]` represents the global translation of the body
